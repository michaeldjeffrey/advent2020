...
read_input(test2) -> read_input("apps/seven/src/test2.txt");
read_input(test) -> read_input("apps/seven/src/test.txt");
read_input(main) -> read_input("apps/seven/src/input.txt");
read_input(Filename) ->
